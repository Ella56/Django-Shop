    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_code', models.CharField(blank=True, max_length=10, null=True, unique=True, validators=[django.core.validators.RegexValidator(message=' کد ملی باید 10 کارکتر عددی باشد و تکراری نباشد', regex='^\\d{10}$')])),
